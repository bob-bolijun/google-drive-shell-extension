...
"C:\Program Files (x86)\NSIS\makensis.exe" /V2 /DOUTPUT_PATH=bin\DriveFusion.exe /D32BIT_MSI_FILE_PATH=.\bin\Debug\x86\Installer\DriveFusion.msi /D64BIT_MSI_FILE_PATH=.\bin\Debug\x64\Installer\DriveFusion.msi /DVersion=1.0.0.0 /DPRODUCT_NAME="…ÓŒ˙‘∆≈Ã" wrapper.nsi
